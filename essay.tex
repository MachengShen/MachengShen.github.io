...
\newcommand{\citejump}[2]{\hyperref[#1]{(#2)}}
...
\begin{itemize}
\item $x_t$ denote the environment state,
\item $o_t$ denote the observation available to the system,
\item $z_t$ denote the system's internal state,
\item $a_t$ denote the action taken by the system,
\item $\theta_t$ denote longer-timescale parameters, memory, or structural degrees of freedom.
\end{itemize}
...
\end{align}
This is not yet a theory of intelligence, but it does clarify the object of study. Supervised learning appears here as a limiting case in which action does not materially affect future observations, the learning rule is mainly offline, and the causal loop is partially cut. General intelligence, by contrast, seems closer to the full closed-loop case. This scaffold also helps sharpen a thought that originally appears as talk of "inverse transfer functions" or identity relations. The stronger and more mathematically plausible question is not whether the agent reproduces the world's transfer function exactly. It is whether there exists a representation map $\phi$ and internal dynamics $\hat{T}_a$ such that, on a task-relevant quotient of state space,
\begin{equation}
...
Research questions:
\begin{itemize}
\item How should "control-sufficient" be defined mathematically?
\item Can it be quantified using information-theoretic sufficiency, controllability, or task-conditioned bisimulation?
\item Under what assumptions can a world model be extracted from a policy in a canonical way?
\end{itemize}
...
Research questions:
\begin{itemize}
\item What is the minimal multiscale architecture required for robust adaptation?
\item Are there impossibility results for single-timescale agents in nonstationary or partially observed environments?
\item How do parametric memory, working memory, tool use, and external memory divide labor across scales?
\end{itemize}
...
Research questions:
\begin{itemize}
\item Can we identify task families with measurable thresholds that are independent of arbitrary benchmark metrics?
\item How can we distinguish true dynamical phase transitions from artifacts induced by thresholded evaluation?
\item What internal observables best track capability transitions?
\end{itemize}
...
Research questions:
\begin{itemize}
\item Can generalization, memory formation, and energy dissipation be brought into a common formalism?
\item Are there experimentally meaningful lower bounds on the cost of adapting to classes of environments?
\item Which architectural motifs improve adaptation per unit of physical cost?
\end{itemize}
...
\item \label{ref:bahri2020}
Bahri, Y., Kadmon, J., Pennington, J., Schoenholz, S. S., Sohl-Dickstein, J., \& Ganguli, S. (2020). Statistical mechanics of deep learning. \textit{Annual Review of Condensed Matter Physics}, 11, 501--528.
\href{https://doi.org/10.1146/annurev-conmatphys-031119-050745}{\nolinkurl{https://doi.org/10.1146/annurev-conmatphys-031119-050745}}

\item \label{ref:conant1970}
...
\href{https://doi.org/10.1080/00207727008920220}{\nolinkurl{https://doi.org/10.1080/00207727008920220}}

\item \label{ref:kaplan2020}
...
\href{https://arxiv.org/abs/2001.08361}{\nolinkurl{https://arxiv.org/abs/2001.08361}}

\item \label{ref:landauer1961}
Landauer, R. (1961). Irreversibility and heat generation in the computing process. \textit{IBM Journal of Research and Development}, 5(3), 183--191.
\href{https://doi.org/10.1147/rd.53.0183}{\nolinkurl{https://doi.org/10.1147/rd.53.0183}}

\item \label{ref:levine2018}
Levine, S. (2018). Reinforcement learning and control as probabilistic inference: Tutorial and review. \textit{arXiv preprint} arXiv:1805.00909.
\href{https://arxiv.org/abs/1805.00909}{\nolinkurl{https://arxiv.org/abs/1805.00909}}

\item \label{ref:marr1982}
Marr, D. (1982). \textit{Vision: A computational investigation into the human representation and processing of visual information}. W. H. Freeman.

\item \label{ref:mcmillen2024}
...
\href{https://doi.org/10.1038/s42003-024-06034-3}{\nolinkurl{https://doi.org/10.1038/s42003-024-06034-3}}

\item \label{ref:richens2025}
Richens, J., Everitt, T., \& Abel, D. (2025). General agents need world models. In \textit{Proceedings of the 42nd International Conference on Machine Learning} (PMLR 267, pp. 51659--51687).
\href{https://proceedings.mlr.press/v267/richens25a.html}{\nolinkurl{https://proceedings.mlr.press/v267/richens25a.html}}

\item \label{ref:schaeffer2023}
Schaeffer, R., Miranda, B., \& Koyejo, S. (2023). Are emergent abilities of large language models a mirage? In \textit{Advances in Neural Information Processing Systems 36}.
\href{https://arxiv.org/abs/2304.15004}{\nolinkurl{https://arxiv.org/abs/2304.15004}}

\item \label{ref:tishby2000}
Tishby, N., Pereira, F. C., \& Bialek, W. (2000). The information bottleneck method. \textit{arXiv preprint} arXiv:physics/0004057.
\href{https://arxiv.org/abs/physics/0004057}{\nolinkurl{https://arxiv.org/abs/physics/0004057}}

\item \label{ref:xu2017}
Xu, A., \& Raginsky, M. (2017). Information-theoretic analysis of generalization capability of learning algorithms. In \textit{Advances in Neural Information Processing Systems 30}.
\href{https://proceedings.neurips.cc/paper/2017/hash/ad71c82b22f4f65b9398f76d8be4c615-Abstract.html}{\nolinkurl{https://proceedings.neurips.cc/paper/2017/hash/ad71c82b22f4f65b9398f76d8be4c615-Abstract.html}}

\item \label{ref:zhang2024}
Zhang, Z., \& Xu, F. (2024). An overview of the free energy principle and related research. \textit{Neural Computation}, 36(5), 963--1021.
\href{https://doi.org/10.1162/neco_a_01661}{\nolinkurl{https://doi.org/10.1162/neco_a_01661}}
\end{enumerate}
\end{document}
